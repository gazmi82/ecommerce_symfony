...
return [
    ...
    [ // $staticRoutes
        ...
        '/' => [[['_route' => 'home', '_controller' => 'App\\Controller\\MainController::index'], null, null, ['https' => 0], false, false, null]],
        ...
        '/user/list' => [[['_route' => 'list', '_controller' => 'App\\Controller\\UserController::list'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
